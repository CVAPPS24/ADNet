...
class Temp2(nn.Module):
    def __init__(self, block, layers, heads,resolution,mhsa, shortcut_type='B'):
        ...
        self.layer3 = self._make_layer(
            block, 256, layers[2], shortcut_type, stride=2, dilation=2,heads=heads,mhsa=mhsa)
        self.avgpool = nn.AdaptiveAvgPool3d((1, 1, 1))
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        #self.avgpool = nn.AdaptiveAvgPool3d((1, 1, 1))
        self.fc1 = nn.Linear(256 * block.expansion, 1)
        self.fc2 = nn.Linear(256 * block.expansion, num_seg_classes)
